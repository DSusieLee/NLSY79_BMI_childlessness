...
racegroup <- c("A. Blacks","B. Hispanics","C. Whites")
bmigroup <- c("U","H","OV","O")

#women
simdt <- readRDS('./Data/220227_simdt_women.rds') %>%
  mutate(race = ifelse(race %in% "Blacks", "A. Blacks",
                       ifelse(race %in% "Hispanics", "B. Hispanics", "C. Whites")))
...
ggsave('./Figures/220228_posterior_contrast_women.png', type = "cairo")


#men
simdt <- readRDS('./Data/220227_simdt_men.rds') %>%
  mutate(race = ifelse(race %in% "Blacks", "A. Blacks",
                       ifelse(race %in% "Hispanics", "B. Hispanics", "C. Whites")))
...
ggsave('./Figures/220119_posterior_contrast_men.png', type = "cairo")   
