...
dt <- readRDS("./Data/NLSY79_finalset(210220)_7060.RDS")
...
#excluding self-identified native american
dt <- subset(dt, racecode != 9)
...
tab_model(m1, m2, m4, m3, m5, m9, m10,
          ...
          linebreak = T, 
          collapse.ci = T,
          file = '210531_lpm_wodesire_men_natam.doc')
...
tab_model(f1, f2, f4, f3, f5, f9, f10,
          ...
          linebreak = T, 
          collapse.ci = T,
          file = '210531_lpm_wodesire_women_natam.doc')
