...
saveRDS(sim_disabled_f, './Results/211208_sim_RBdisabeled_f.rds')
saveRDS(sim_disabled_m, './Results/211208_sim_RBdisabeled_m.rds')
saveRDS(sim_enabled_f, './Results/211208_sim_RBenabeled_f.rds')
saveRDS(sim_enabled_m, './Results/211208_sim_RBenabeled_m.rds')
